...
export default function BannerStrip() {
  ...
  useEffect(() => {
    getActiveBanners().then((data) => setBanners(data));
  }, []);
  ...
  return (
    <section className="border-b border-[var(--color-line)] bg-[var(--color-paper)] py-4 sm:py-6">
      <div className="mx-auto max-w-6xl px-4">
        <div className="group relative overflow-hidden rounded-xl border border-[var(--color-line)] bg-[var(--color-paper-dim)] shadow-sm">
          {/* Slides Container */}
          <div
